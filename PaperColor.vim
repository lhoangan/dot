...
fun! s:set_highlightings_variable()
  ...
  " Python Highlighting
  call s:HL("pythonImport", s:orange, "", s:bold)
  ...
  call s:HL("pythonConditional", s:blue, "", s:bold)
  call s:HL("pythonRepeat", s:blue, "", s:bold)
  call s:HL("pythonFunction", s:green, "", s:bold)
  call s:HL("pythonPreCondit", s:aqua, "", "")
  call s:HL("pythonExClass", s:orange, "", "")
  call s:HL("pythonOperator", s:aqua, "", s:bold)
  call s:HL("pythonBuiltin", s:pink, "", "")
  ...
  call s:HL("pythonDottedName", s:blue, "", "")
  call s:HL("pythonStrFormat", s:orange, "", "")
